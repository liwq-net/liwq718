...
namespace cocos2d
{
    public class CCTiledGrid3D : CCGridBase
    {
        ...
        {
            float width = m_pTexture.Width;
            float height = m_pTexture.Height;
        ...
        public new static CCTiledGrid3D gridWithSize(ccGridSize gridSize, Texture pTexture, bool bFlipped)
        {
