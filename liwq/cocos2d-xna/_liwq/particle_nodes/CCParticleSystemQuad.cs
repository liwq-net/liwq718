    ...
    */
    public class CCParticleSystemQuad : CCParticleSystem
    {
        ...
        */
        ...
        {
            Debug.Assert(spriteFrame.OffsetInPixels.X == 0 && spriteFrame.OffsetInPixels.Y == 0, "QuadParticle only supports SpriteFrames with no offsets");
	    ...
	    @since v0.99.4
	    */
        public void setTextureWithRect(Texture texture, CCRect rect)
        {
        ...
        public override bool initWithTotalParticles(uint numberOfParticles)
        {
            ...
            if (base.initWithTotalParticles(numberOfParticles))
            {
                ...
                if (this.Texture != null)
                {
                    initTexCoordsWithRect(new CCRect((float)0, (float)0, (float)this.Texture.Width, (float)this.Texture.Height));
                }
                else
                {
